      ...
      >
        <q-card-section class="row items-center no-wrap">
          ...
          <div class="col">
            ...
            <div class="twitter-cards__stamp text-grey-8"
              >@{{ tweet.handle }}</div
            >
          </div>
          <q-icon
...
function localUpdateArrows() {
  ...
  if (el) {
    ...
    rightArrowClass.value =
      scrollLeft + offsetWidth >= scrollWidth ? hiddenArrowClass : null
  }
}
...
const tweetsList = [
...

  {
    ...
    handle: 'maurietchev',
    message:
      "I'm gonna marry @quasarframework. It was love at first sight ♥️♥️♥️",
