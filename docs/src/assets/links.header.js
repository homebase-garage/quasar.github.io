...
export const versionLinks = [
  {
    ...
    children: [
      ...
      },
      {
        name: 'Report a bug',
        icon: mdiBug,
        path: 'https://github.com/quasarframework/quasar/issues',
        external: true
      },
      {
      ...
      {
        name: 'v0.17',
        path: 'https://v0-17.quasar-framework.org/',
        external: true
      },
      {
        name: 'v0.16',
        path: 'https://v0-16.quasar-framework.org/',
        external: true
      },
      {
        name: 'v0.15',
        path: 'https://v0-15.quasar-framework.org/',
        external: true
      },
      {
        name: 'v0.14',
        path: 'https://v0-14.quasar-framework.org/',
        external: true
      },
      {
        name: 'v0.13',
        path: 'https://v0-13.quasar-framework.org/',
        external: true
      }
    ]
  }
...
const tools = {
  ...
  children: [
    ...
    },
    {
      name: 'Codepen',
      icon: mdiCodepen,
      path: 'https://codepen.quasar.dev',
      external: true
    },
    {
      name: 'jsFiddle',
      icon: mdiJsfiddle,
      path: 'https://jsfiddle.quasar.dev',
      external: true
    },
    {
      name: 'Stackblitz',
    ...
    },
    {
      name: 'Codesandbox',
      icon: fasCubes,
      path: 'https://codesandbox.quasar.dev',
      external: true
    }
  ]
}
