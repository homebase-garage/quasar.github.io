...
export const footerLinks = [
  {
    ...
    children: [{ name: 'Quasar Team', path: '/meet-the-team' }]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/quasar-cli-vite/developing-capacitor-apps/introduction'
      },
      {
        name: 'Developing Cordova Apps',
        path: '/quasar-cli-vite/developing-cordova-apps/introduction'
      },
      {
