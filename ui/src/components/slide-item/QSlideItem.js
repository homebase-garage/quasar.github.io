...
export default createComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    function emitSlide(side, ratio, isReset) {
      if (props.onSlide !== void 0) emit('slide', { side, ratio, isReset })
    }
      ...
      if (evt.isFirst) {
        ...
        slotsDef.forEach(slotName => {
          if (slots[slotName[0]] !== void 0) {
            ...
            pan.size[slotName[0]] =
              localNode.getBoundingClientRect()[slotName[3]]
          }
        })
          ...
          content.push(
            h(
              'div',
              {
                ...
                class:
                  `q-slide-item__${dir} absolute-full row no-wrap items-${slotName[1]} justify-${slotName[2]}` +
                  (props[dir + 'Color'] !== void 0
                    ? ` bg-${props[dir + 'Color']}`
                    : '')
              },
              [
        ...
        content.push(
          withDirectives(
            ...
            getCache('dir#' + dirs.join(''), () => {
              ...
              return [[TouchPan, onPan, void 0, modifiers]]
            })
          )
        )
      }
