      ...
      <div class="row justify-center group">
        <div>
          <q-btn
            ...
            size="sm"
            color="secondary"
            @click="alertAsMethod('bottom-left')"
          >
        ...
        <div>
          <q-btn
            ...
            size="sm"
            color="secondary"
            @click="alertAsMethod('bottom-right')"
          >
