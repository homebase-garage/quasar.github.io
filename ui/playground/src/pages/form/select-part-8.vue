        ...
        <q-menu class="q-menu-class">
          <q-list bordered padding>
            ...
            <q-item clickable v-ripple>
              <q-item-section>
                ...
                <q-item-label caption class="text-bold"
                  >Only on mobile device (tested on Android), when an item is
                  selected, the nativ keyboard appears when it is not the
                  expected behaviour because the q-select does not need keyboard
                  interaction.</q-item-label
                >
                <q-item-label class="text-red"
                  >Unexpected behaviour !</q-item-label
                >
                <q-item-label>
                  <q-select
            ...
            <q-item clickable v-ripple>
              <q-item-section>
                <q-item-label
                  >Color selection (select multiple values)</q-item-label
                >
                <q-item-label caption class="text-bold"
                  >But with multiple select, when items are selected, the nativ
                  keyboard does not appear.</q-item-label
                >
                <q-item-label class="text-green"
                  >Expected behaviour !</q-item-label
                >
                <q-item-label>
                  <q-select
