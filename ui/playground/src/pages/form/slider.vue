  ...
  >
    ...
    >
      ...
      <q-input
        ...
        :dark="dark"
        label="Label template - use {model}"
      />
    </div>
    ...
    <div class="col scroll q-pl-md q-pr-xl q-gutter-y-lg">
      ...
      <div class="row justify-around">
        ...
        <q-slider
          ...
          :max="50"
          label
          :label-value="labelValue(standalone)"
        />
        <q-slider
          :vertical="vertical"
          :dark="dark"
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ innerMinMax }}</em> &nbsp;&nbsp;(0 to 50, inner 10 to 35 or
            15 to 40)</span
          >
        </span>
      </p>
      ...
      <q-slider
        ...
        reverse
        label
        :label-value="labelValue(stepZero)"
      />
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ precision }}</em> &nbsp;&nbsp;(0.1 to 2.0, step 0.01)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ step }}</em> &nbsp;&nbsp;(0 to 45, step 5)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ label }}</em> &nbsp;&nbsp;(-10 to 10, step 4)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ snap }}</em> &nbsp;&nbsp;(0 to 10, step 2)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ marker }}</em> &nbsp;&nbsp;(0 to 10, step 2)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ label }}</em> &nbsp;&nbsp;(-20000 to 20000, step 400)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ label }}</em> &nbsp;&nbsp;(-20 to 20, step 4)</span
          >
        </span>
      </p>
      <q-slider
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ nullValue === null ? 'null' : nullValue }}</em>
            &nbsp;&nbsp;(0 to 50)</span
          >
        </span>
      </p>
      ...
      <p class="caption">
        ...
        <span class="label inline bg-secondary text-white">
          Model
          <span class="right-detail"
            ><em>{{ nullValueMin === null ? 'null' : nullValueMin }}</em>
            &nbsp;&nbsp;(20 to 50)</span
          >
        </span>
      </p>
