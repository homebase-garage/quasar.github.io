<template>
  <div>
    <div class="q-layout-padding" :class="dark ? 'bg-black text-white' : ''">
      ...
      <div class="q-gutter-md">
        <q-radio
          :checked-icon="mdiCheckboxMarkedCircleOutline"
        ...
        <div class="row q-col-gutter-x-sm">
          <label tabindex="0" class="col">
            <q-radio
              ...
              val="opt1"
              color="orange"
              label="Radio Opt 1 - own label (tabindex)"
              :dark="dark"
              :dense="dense"
              :keep-color="keepColor"
            />
          ...
          <label tabindex="0" class="col">
            <q-radio
              ...
              val="opt2"
              color="orange"
              label="Radio Opt 2 - own label (tabindex)"
              :dark="dark"
              :dense="dense"
              :keep-color="keepColor"
            />
