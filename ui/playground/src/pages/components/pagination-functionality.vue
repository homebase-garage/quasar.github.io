  ...
  <div>
    <div class="q-layout-padding">
      ...
      <p class="caption">
        ...
        on the Input box and type out another page number then hit &lt;ENTER&gt;
      </p>
      ...
      <div class="row q-gutter-sm items-center">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
          <q-select
            ...
            filled
            stack-label
            label="Always show first and last page"
          />
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
          <q-select
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
          <q-input
            ...
            filled
            stack-label
            label="Maximum number of page buttons"
          />
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
