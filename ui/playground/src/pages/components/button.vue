  ...
  <div>
    <div class="q-layout-padding buttons-test">
      <q-btn
        ...
        size="50px"
        label="clickme"
        @click="e => handle('click', e, true)"
        @keyup="e => handle('keyup', e)"
        @keydown="e => handle('keydown', e)"
      />
      <button
        @click="e => handle('click', e)"
        @keyup="e => handle('keyup', e)"
        @keydown="e => handle('keydown', e)"
      >
        My btn
      ...
      <q-toggle
        v-model="tag"
        :label="tag === 'button' ? 'Button' : 'Link'"
        true-value="button"
        false-value="a"
      />
      <div class="q-gutter-sm">
        <template
          v-for="n in ['xs', 'sm', 'md', 'lg', 'xl']"
          :key="`n_1_1_${n}`"
        >
      ...
      <div class="q-mt-md">
        ...
        <form
          ...
          @reset.prevent="reset"
          class="shadow-2 q-pa-md row items-center"
        >
      ...
      <q-btn
        :type="tag"
        color="primary"
        label="Some very, but very long button title that should wrap to the next line without any problems"
      />
      ...
      <div class="q-gutter-sm">
        <q-btn
          ...
          color="primary"
          class="full-width"
          label="Full-width Full-width Full-width Full-width Full-width Full-width Full-width Full-width Full-width"
        />
        <q-btn
          :type="tag"
          color="secondary"
      ...
      <div class="q-gutter-sm">
        ...
        <q-btn
          ...
          size="sm"
        >
          Very long text that should wrap on the next line. I really mean it,
          it's a very long text. Maybe it's not clear, but it should be very,
          very long, so long that even a fullscreen width is not enough. I know
          it's not easy, but we should try.
        </q-btn>
        <q-btn
          :type="tag"
          color="primary"
      ...
      <div class="q-gutter-sm" style="width: 610px">
        ...
        <q-btn
          ...
          color="primary"
          no-wrap
          label="No wrap. Full-width Full-width Full-width Full-width Full-width Full-width Full-width Full-width Full-width"
        />
        <q-btn
          :type="tag"
          color="primary"
          no-wrap
          label="No wrap with label prop. Full-width Full-width Full-width Full-width Full-width Full-width Full-width Full-width Full-width"
        />
      </div>
      ...
      <div v-for="size in sizes" :key="'f' + size">
        ...
        <q-btn
          :type="tag"
          class="bg-primary text-white disabled"
          :size="size"
          label="Disabled"
        />
        <q-btn
