<template>
  <div
    class="q-layout-padding docs-carousel"
    style="max-width: 600px; padding-top: 135px"
  >
    <div
      class="fixed-top full-width z-top row items-center bg-grey-6 q-gutter-md"
    >
      <q-btn
        label="fullscreen"
        color="purple"
        @click="$refs.carousel.toggleFullscreen()"
      />
      <q-select
        dense
        filled
        v-model="navigationPosition"
    ...
    <q-responsive :ratio="16 / 9">
      ...
      >
        ...
        <q-carousel-slide
          name="x"
          img-src="https://cdn.quasar.dev/img/parallax2.jpg"
          class="text-white scroll text-center"
        >
    ...
    >
      ...
      >
        <q-scroll-area class="fit">
          <div
            class="column no-wrap flex-center test-scroll-container q-carousel--padding"
          >
            <q-icon name="style" size="56px" />
            <div class="q-mt-md text-center">
              {{ lorem }}
    ...
    >
      ...
      <template v-slot:control>
        <q-carousel-control position="top-right" :offset="[38, 38]">
          <q-btn
            push
            round
            dense
