    ...
    <div class="q-layout-padding">
      ...
      <div class="q-gutter-sm">
        ...
        <q-btn color="primary" icon="map">
          <q-menu
            @show="log('@show popover_map')"
            @hide="log('@hide popover_map')"
          ...
          >
            <div class="column q-gutter-md">
              <q-select
                ...
                behavior="menu"
                filled
                label="Select single - menu"
                clearable
              />
              <q-select
                v-model="selectModelM"
                :options="selectOptions"
                behavior="menu"
                filled
                multiple
      ...
      <div class="q-gutter-md q-my-md">
        ...
        <q-card class="q-mx-auto" style="width: 500px; max-width: 90vw">
          <q-card-section> Menu in menu </q-card-section>
          <q-img
                ...
                <q-item v-for="n in 3" :key="n" clickable>
                  ...
                  <q-menu anchor="top right" self="top left">
                    <q-list>
                      ...
                      <q-item v-for="x in 3" :key="x" clickable>
        ...
        <div class="row q-pa-sm">
          ...
          <div class="col-4">
            <q-select
              ...
              behavior="menu"
              filled
              label="Select single - menu - cover"
              options-cover
            />
          </div>
        </div>
        ...
        <q-menu ref="popover4">
          <div class="group" style="width: 220px; text-align: center">
            <q-btn
              ...
              flat
              color="primary"
              @click="(showNotify(), $refs.popover4.hide())"
            />
            <q-btn
              icon="thumb_down"
              flat
