    ...
    <div class="">
      ...
      <q-tabs :dense="dense">
        <q-tab label="Item one - tooltip">
          <q-tooltip> <q-icon name="wifi" /> Wifi </q-tooltip>
        </q-tab>
      ...
      <q-tabs :dense="dense" class="test q-mt-sm">
        ...
        <q-route-tab
          ...
          replace
          :to="{ name: 'ta', params: $route.params }"
          exact
          :label="`t/${$route.params.id}/a`"
        />
        <q-route-tab
          v-if="$route.params.id"
          replace
          :to="{ name: 'tb', params: $route.params }"
          exact
          :label="`t/${$route.params.id}/b`"
        />
      </q-tabs>
      ...
      <q-toggle
        v-model="useR1Q1Disabled"
        label="Insert r.1 q=1 loose & disabled"
      />
      <q-tabs
        :dense="dense"
        class="test q-mt-sm"
        active-class="test-active-class"
        no-caps
        outside-arrows
      >
        <q-tab label="Gigi" />
        ...
        <q-route-tab
          v-if="loose && useR1Q1Disabled"
          replace
          :to="{ name: 'r.1', query: { q: '1' } }"
          label="r.1 q=1 * disabled"
          disable
        />
        <q-route-tab
          v-if="loose"
      ...
      <q-tabs :dense="dense" class="test q-mt-sm">
        <q-route-tab
          replace
          :to="{ name: 'r.1' }"
          label="r.1 - delay 2sec"
          @click="routeNavDelay"
        />
        <q-route-tab
          replace
          :to="{ name: 'r.1.1' }"
          label="r.1.1 disabled - delay 2sec"
          disable
          @click="routeNavDelay"
        />
        <q-route-tab
          replace
          :to="{ name: 'r.2' }"
          label="r.2 - passthrough"
          @click="routeNavPass"
        />
        <q-route-tab
          replace
          :to="{ name: 'r.2' }"
          label="r.2 - delay 2sec"
          @click="routeNavDelay"
        />
        <q-route-tab
          replace
          :to="{ name: 'r.2' }"
          label="r.2 - cancel"
          @click="routeNavCancel"
        />
        <q-route-tab
          replace
          :to="{ name: 'r.3' }"
          label="r.3 - redirect to r.1.1"
          @click="routeNavChange"
        />
      </q-tabs>
      ...
      <q-tabs
        ...
        @update:model-value="onChangeTab1"
        class="bg-grey-1 text-teal"
      >
      ...
      <q-tabs
        :dense="dense"
        :model-value="tabModel"
        @update:model-value="onChangeTab2"
        class="bg-grey-1 text-teal"
      >
      ...
      <q-toggle
        v-model="panelTest"
        label="Panel test; Swap one with two / Remove tab two"
      />
      ...
      <div class="shadow-1 q-ma-md">
        ...
        >
          <q-tab-panel :name="panelTest ? 'two' : 'one'">
            ...
            Tab One <strong v-if="panelTest">(Swapped)</strong> <br />
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident
            obcaecati repellendus dolores totam nostrum ut repudiandae
            perspiciatis est accusamus, eaque natus modi rem beatae optio
            cumque, velit ducimus autem magnam.
            <keep-alive-test name="one" />
          </q-tab-panel>

          <q-tab-panel :name="panelTest ? 'one' : 'two'">
            Tab Two <strong v-if="panelTest">(Swapped)</strong> <br />
            Lorem ipsum dolor sit amet consectetur adipisicing elit. At iusto
            neque odio porro, animi ducimus iure autem commodi sint, magni
            voluptatum molestias illo accusamus voluptate ratione aperiam.
            Saepe, fugiat vel.
          ...
          <q-tab-panel name="three">
            ...
            deserunt praesentium cumque distinctio placeat, recusandae id qui
            odit similique officia? Mollitia, ea!
      ...
      >
        <q-tab-panel name="one">
          <q-btn dense round icon="map" class="absolute-bottom-right" />
          v-if test Tab One <br />
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident
          obcaecati repellendus dolores totam nostrum ut repudiandae
          perspiciatis est accusamus, eaque natus modi rem beatae optio cumque,
          velit ducimus autem magnam.
        </q-tab-panel>

        <q-tab-panel v-if="!panelTest" name="two">
          v-if test Tab Two <br />
          Lorem ipsum dolor sit amet consectetur adipisicing elit. At iusto
          neque odio porro, animi ducimus iure autem commodi sint, magni
          voluptatum molestias illo accusamus voluptate ratione aperiam. Saepe,
          fugiat vel.
        </q-tab-panel>

        <q-tab-panel name="three">
          v-if test Tab Three <br />
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis labore
          inventore accusantium, perferendis eos sapiente culpa consectetur
