    ...
    <div class="q-layout-padding q-mx-auto" style="max-width: 600px">
      ...
      <q-list bordered>
        ...
        <q-expansion-item
          expand-separator
          icon="explore"
          label="With right-side icon too"
        >
          <q-card>
            <q-card-section>
              {{ lorem }}
          ...
          <template v-slot:header="{ expanded }">
            ...
            <q-item-section>
              <div>
                ...
                <q-badge color="secondary"> Using slot </q-badge>
              </div>
            </q-item-section>
        ...
        <q-expansion-item
          expand-separator
          dense
          label="With textarea autogrow - default CLOSED"
        >
          <div class="q-pa-md">
            <q-input
              v-model="lorem"
        ...
        <q-expansion-item
          expand-separator
          dense
          label="With textarea autogrow - default OPENED"
          default-opened
        >
          <div class="q-pa-md">
            <q-input
      ...
      >
        <q-card>
          <q-card-section>
            ...
            voluptatum natus consectetur ipsam laboriosam tenetur? Et ducimus
            quaerat labore a amet distinctio, facilis dolores, iusto, quam
            excepturi tempora porro fugit?
            <q-btn label="Btn" />
          </q-card-section>
        </q-card>
      </q-expansion-item>
      ...
      >
        <q-card>
          <q-card-section>
            ...
            soluta neque, earum porro nostrum odio iure numquam temporibus
            beatae non reiciendis consequuntur. Minima reiciendis, modi possimus
            explicabo beatae necessitatibus voluptas.
            <q-btn label="Btn" />
          </q-card-section>
        </q-card>
      </q-expansion-item>
      ...
      <div class="q-mb-sm">
        <q-toggle
          v-model="somegroup"
          true-value="somegroup"
          false-value="othergroup"
          label="Last two have same group"
        />
      </div>
        ...
        <q-expansion-item icon="explore" label="First Card">
          <q-card class="bg-grey-3">
            <q-card-section>
              ...
              vero vitae consequatur, id commodi magnam deleniti voluptas,
              alias, numquam labore maiores sit a dolores aliquid molestias
              veritatis nulla. Deleniti, debitis?
            </q-card-section>
          </q-card>
        </q-expansion-item>
